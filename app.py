...
i = 0
# Funcion para ir agregando al input los numeros digitados
def get_numbers(n):
    global i
    display.insert(i, n)
    i += 1

# Funcion para ir agregando al input los operadores
def get_operation(operator):
    global i
    operatorlenght = len(operator)
...
# Funcion que borra el ultimo digitado
def undo():
